      ...
      <div className="bg-white p-1">
        ...
        <section className="grid grid-rows-5 pt-3">
          <div className="h-12 p-1 grid grid-cols-4 gap-2 font-roboto">
            ...
            <div className="flex justify-center"><button id="Del" onClick={(e) => deleteLast()} className="shadow focus:shadow-none w-full h-full bg-yellow-200 rounded-md border-yellow-300 text-yellow-600">Del</button></div>
